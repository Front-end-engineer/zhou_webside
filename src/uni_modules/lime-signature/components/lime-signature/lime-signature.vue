<template>
  <view class="signature" :class="{ landscape }">
    ...
    <view class="tools">
      ...
      <!-- <view class="tools-item" @tap="onClick('restore')">
        <image
          class="tools-item__image restore"
          src="https://fastly.jsdelivr.net/gh/liangei/image@latest/reply-fill.svg"
          mode="widthFix"
        ></image>
        <text>上一步</text>
    ...
    <uni-popup ref="popup" type="center" @change="isShowPen = $event.show">
      <view class="popup-wrap">
        <view class="popup-item">
          ...
          <slider
            :value="penSize"
            max="20"
            @change="penSize = $event.detail.value"
            show-value
          />
        </view>
      </view>
    ...
    <!-- <view class="signature-preview" v-if="url">
      <image
        class="signature-preview__image"
        :src="url"
        mode="widthFix"
      ></image>
    </view> -->
    ...
    onClick(type) {
      ...
      if (type == "save") {
        ...
        uni.canvasToTempFilePath({
          quality: 0.8,
          canvasId: signatureRef.canvasId,
          success: (res) => {
            this.url = res.tempFilePath;
          },
        });
