          ...
          <template #dropdown>
            <el-dropdown-menu>
              ...
              <template v-if="wallet.connected">
                ...
                <el-dropdown-item @click="walletLinker.disconnectWallet">
                  <view class="lang-item"> 断开 {{ wallet.chain }} </view>
                </el-dropdown-item>
              </template>
              <template v-else>
                <el-dropdown-item @click="walletLinker.connectWallet('eth')">
                  <view class="lang-item">
                    {{ $t("header.connect") }} ETC
                  </view>
                </el-dropdown-item>
                <el-dropdown-item @click="walletLinker.connectWallet('bsc')">
                  <view class="lang-item">
                    {{ $t("header.connect") }} BSC
                  </view>
                </el-dropdown-item>
                <el-dropdown-item @click="walletLinker.connectWallet('tron')">
                  <view class="lang-item">
                    {{ $t("header.connect") }} Tron
                  </view>
                </el-dropdown-item>
              </template>
